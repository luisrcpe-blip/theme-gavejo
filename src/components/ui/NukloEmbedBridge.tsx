...
function getContentHeight() {
  const contentNodes = Array.from(document.body.querySelectorAll("main, main > section, body > footer"));
...
export function NukloEmbedBridge() {
  useEffect(() => {
    ...
    Array.from(document.body.querySelectorAll("main, main > section, body > footer")).forEach((child) => observer.observe(child));
